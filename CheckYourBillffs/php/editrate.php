            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Edit <?= $data['unit'] ?></h6>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
                                    <label class="form-label">Device Unit</label>
                                    <input type="number" value="<?= $data['unit'] ?>" name="unit" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
                                    <label class="form-label">Device Rate</label>
                                    <input type="number" value="<?= $data['rate'] ?>" name="rate" class="form-control">
                                </div>
                            </div>
